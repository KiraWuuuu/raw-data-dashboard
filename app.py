...
st.set_page_config(page_title="Tracking Builder", layout="wide")
...
def format_excel(ws, df):
    ...
    accounting = '_-"¥"* #,##0.00_-;[Red]\\-"¥"* -#,##0.00_-;_-"¥"* "-"??_-'
    integer = '#,##0'
    decimal2 = '0.00'
    percent = '0.00%'
...
mapping = st.file_uploader("Upload Mapping Config")
...
if st.button("Generate Dashboard"):
    ...
    st.download_button("Download Excel", excel, file_name="Final.xlsx")
